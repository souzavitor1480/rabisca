import { alternarIcone, detectarCliqueSemPropagacao, enviarDados } from './modulos/utilitarios.js';
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    detectarCliqueSemPropagacao(botaoAlternarMenuNavegacao, () => {
        alternarMenuNavegacao(!areaLinksMenuNavegacao.classList.contains('ativo'));
    });

    detectarCliqueSemPropagacao(botaoAlternarBotoesAcessibilidade, () => {
